from matematicas import es_par, es_primo, es_multiplo
...
def iniciar_sesion():
    ...
    while login == False:
        ...
        cuenta = input("Ingrese 'Registrarse' o 'Iniciar sesion': ").lower()

        while cuenta != "registrarse" and cuenta != "iniciar sesion":
            cuenta = input("Por favor , Ingrese 'Registrarse' o 'Iniciar sesion': ").lower()
